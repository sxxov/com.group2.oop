...
import com.group2.oop.voucher.adminVoucher;
  ...
  public void init(Engine engine) {
    ...
    while (true) {
      ...
      System.out.println("6. Show all images");
                        System.out.println("7. Edit Voucher");
      System.out.println("");
      ...
      switch (choice) {
        case 1:
          ...
          for (;;) {
            ...
            System.out.println("");
            System.out.println("0. Exit");
            System.out.println("Enter the number of the image to reject: ");
            System.out.print("> ");
            int i;
        ...
        case 6:
          ...
          return;
                                ...
                                case 7:
                                  System.out.print("[Edit Voucher]\n\n");
                                  engine.swap(new adminVoucher());
                                  return;
